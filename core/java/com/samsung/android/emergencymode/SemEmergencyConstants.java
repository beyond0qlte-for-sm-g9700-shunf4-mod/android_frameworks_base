...
public class SemEmergencyConstants {
    ...
    public static final String AUTHORITY = "com.samsung.android.emergencymode";
    ...
    public static final Uri URI_WHITELIST = Uri.parse("content://com.samsung.android.emergencymode/whitelist");
    public static final Uri URI_PREFSETTINGS = Uri.parse("content://com.samsung.android.emergencymode/prefsettings");
    public static final Uri URI_DISABLEDPKG = Uri.parse("content://com.samsung.android.emergencymode/disabledpkg");
    public static final Uri URI_ALARM = Uri.parse("content://com.samsung.android.emergencymode/alarm");
    public static final Uri URI_ECCLIST = Uri.parse("content://com.samsung.android.emergencymode/ecclist");
    public static final Uri URI_LAUNCHER_DEFAULT = Uri.parse("content://com.samsung.android.emergencymode/launcherdefault");
    public static final Uri URI_LAUNCHER_ADD = Uri.parse("content://com.samsung.android.emergencymode/launcheradd");
    public static final Uri URI_UPDATE_TABLE = Uri.parse("content://com.samsung.android.emergencymode/updatetable");
